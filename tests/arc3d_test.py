...
class Arc3DTestCase(unittest.TestCase):
    """Test for Arc2D"""

    def test_arc3_init(self):
    ...
    def test_arc3_init_radius(self):
    ...
    def test_arc3_init_reveresed(self):
    ...
    def test_arc3_init_circle(self):
    ...
    def test_arc3_init_from_start_mid_end(self):
    ...
    def test_arc3_to_from_dict(self):
        """Test the initalization of Arc3D objects and basic properties."""
        pt = Point3D(2, 0, 2)
        arc = Arc3D(Plane(o=pt), 1, 0, math.pi)
    ...
    def test_arc3_closest_point(self):
    ...
    def test_arc3_split_with_plane(self):
