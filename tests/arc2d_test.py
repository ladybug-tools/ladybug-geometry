...
class Arc2DTestCase(unittest.TestCase):
    """Test for Arc2D"""

    def test_arc2_init(self):
    ...
    def test_arc2_init_radius(self):
    ...
    def test_arc2_init_reveresed(self):
    ...
    def test_arc2_init_circle(self):
    ...
    def test_arc2_init_from_start_mid_end(self):
    ...
    def test_arc2_to_from_dict(self):
        """Test the initalization of Arc2D objects and basic properties."""
        pt = Point2D(2, 0)
        arc = Arc2D(pt, 1, 0, math.pi)
    ...
    def test_arc2_closest_point(self):
    ...
    def test_arc2_intersect_line_ray(self):
    ...
    def test_arc2_split_line_infinite(self):
